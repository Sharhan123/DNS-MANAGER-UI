...
import { editRecord } from '../../services/userService';
...
function EditRecord({ data, id }) {
    ...
    useEffect(()=>{
        const combined = data.ResourceRecords.map(item => item.Value).join('\n');
                    ...
                    <div className="border border-blue-500 shadow-lg modal-container bg-white w-4/12 md:max-w-11/12 mx-auto rounded-xl shadow-lg z-50 overflow-y-auto">
                        <div className="modal-content py-4 text-left px-6">
                            ...
                            <div className="flex justify-between items-center pb-3">
                                <p className="text-2xl font-bold text-black kanit-semibold">Edit Record</p>
                            ...
                            <div className="my-5 mr-5 ml-5 flex justify-center">
                                <form onSubmit={handleSubmit} method="POST" className="w-full">
                                    <div>
                                        ...
                                        <div>
                                            <input type="text"  id="names" name='id' disabled autoComplete="off" className="text-black h-3 p-6 w-full border-2 border-gray-300 mb-5 rounded-md" value={id} />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <input type="text" onChange={(e)=>setName(e.target.value)}  id="Name" name='Name' value={name} autoComplete="off" className={`text-black h-3 p-6 w-full border-2 ${nameErr ? 'border-red-500' : 'border-gray-300'}  mb-5 rounded-md`} placeholder="sub domain" />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <select name="Type" value={data.Type} className="text-black   p-4 w-full border-2 border-gray-300 mb-5 rounded-md">
                                    ...
                                    <div>
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            rows="5" 
                                            cols="" 
                                            onChange={(e)=>setRecords(prevState => ({
                                                ...prevState,
                                                combinedString: e.target.value
                                            }))}
                                            value={records.combinedString}
                                            placeholder="Enter the values line by line and also ensure that the value is actual format according to the Type." 
                                            className={`w-full border text-black ${value ? 'border-red-500' : 'border-gray-300'}rounded-md py-2 px-3 focus:outline-none focus:border-blue-700`}></textarea>
                                        </div>
